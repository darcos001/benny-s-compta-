# Benny's — Outil de gestion / comptabilité
...
Serveur Benny's démarré sur le port 3001
```
...
4. Tu obtiens une adresse en ligne (ex: `bennys.up.railway.app`).
